...
\begin{figure}[htbp]
   ...
   \caption{Variance of the weighted average of  (a) NEP from CMIP6 ESMs and X-BASE, and (b) NBP from CMIP6 ESMs and the Jena CarboScope product calculated with equation \eqref{eq:avevar}.}
