...
%DIF DEL main.tex     Tue May 20 08:49:53 2025
%DIF ADD mainR1.tex   Sun Aug 10 10:21:11 2025
%% ---------------------------------
...
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=14cm]{Figures/Var.pdf} \DIFaddendFL % requires the graphicx package
   \caption{\DIFdelbeginFL \DIFdelFL{Annual time series }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Variance }\DIFaddendFL of \DIFaddbeginFL \DIFaddFL{the weighted average of  }\DIFaddendFL (a) NEP \DIFaddbeginFL \DIFaddFL{from CMIP6 ESMs }\DIFaddendFL and \DIFaddbeginFL \DIFaddFL{X-BASE, and }\DIFaddendFL (b) NBP from \DIFdelbeginFL \DIFdelFL{individual }\DIFdelendFL CMIP6 ESMs \DIFdelbeginFL \DIFdelFL{obtained as arithmetic averages (purple lines) }\DIFdelendFL and the \DIFdelbeginFL \DIFdelFL{weighted averages using the method proposed here (black lines). Uncertainty ranges are expressed as the average value $\pm$ the full value of $\sigma$ from }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Jena CarboScope product calculated with }\DIFaddendFL equation \DIFdelbeginFL \DIFdelFL{\ref{eq:sigma2}}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{\eqref{eq:avevar}}\DIFaddendFL .\DIFdelbeginFL \DIFdelFL{For the arithmetic average, the weights for the computation of uncertainty are $w_i = 1/8$.}\DIFdelendFL }
